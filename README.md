...
このプロジェクトは、**MDCS（ミセサポ演繹法分類体系）**を開発の主軸としています。

**AIモデル向け**: 開発内容を理解するには、[AI向けクイックスタートガイド](./docs/AI_QUICK_START.md)を参照してください。

## 📐 MDCS（ミセサポ演繹法分類体系）

### 論理構造（3段階）

1. **三段論法（前提の正確性の確保）**: 前提条件の正確性を確かめる
2. **演繹法（前提から結論への展開）**: 前提条件から結論を導く
3. **末広がりな思想（演繹的拡張）**: 基盤から始まって、徐々に広がっていく

**詳細**: [MDCS コア哲学](./docs/MDCS_CORE_PHILOSOPHY.md)
...
1. **顧客接点システム**: パブリック関連 + ユーザー管理
2. **業務実行システム**: 営業マンのツール + 清掃員のユーティリティツール
3. **管理統合システム**: 社内管理システム

**詳細**: [システム機能・ロール別カテゴライズ](./docs/SYSTEM_CATEGORIZATION.md)
